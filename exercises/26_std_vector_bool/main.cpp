...
int main(int argc, char **argv) {
    ...
    // Windows平台MSVC // ASSERT(sizeof(vec) == 4*sizeof(void*), "Fill in the correct value.");
    ASSERT(sizeof(vec) == 5*sizeof(void*), "Fill in the correct value.");       // Linux平台gcc
    {
        vec[20] = false;
